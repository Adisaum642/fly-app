    ...
    <Box sx={{ flexGrow: 1 }}>
      <Grid container spacing={3}>
        ...
        <Grid item xs="auto" className='norway'>
          <Item><img src={Norway} alt="Norway" /><div className='title-paris'>Norway</div ><div ><span className='from'>From</span> <br /> <span className="price-paris">$895</span></div></Item>
        </Grid>
        <Grid item xs="auto" className='tuscany'>
          <Item><img src={Tuscany} alt="Tuscany" /><div className='title-paris'>Tuscany</div ><div ><span className='from'>From</span> <br /> <span className="price-paris">$1245</span></div></Item>
        </Grid>
      </Grid>
    </Box>
  );
